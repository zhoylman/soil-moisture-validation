...
stie_meta = read_csv('/home/zhoylman/soil-moisture-validation-data/processed/standardized-soil-moisture/standardized-station_meta.csv') %>%
...
for(i in 1:length(names)){
  ...
  color_scale = khroma::color("roma") # smooth rainbow
...
write_csv(site_specific_results %>% select(-c('linearFit', 'pearson')), '/home/zhoylman/soil-moisture-validation-data/processed/rmse-comparison/soil-moisture-model-rmse.csv')
